...
<body>
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div>
      <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Iniciar Sesion</a>
...
<div class="min-h-screen items-center">
        <div class="">
            <div class="text-center font-semibold">
                <h1 class="text-5xl">
                    <span class="text-indigo-500 tracking-wide font-bold">Flexible </span>
                    <span class="font-italic">Plans</span>
                </h1>
